...
@WebServlet("/viewRejected")
public class ViewRejectedServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req,
        ...
        out.println("th{background:red;color:white;padding:12px;}");
        out.println("td{padding:10px;text-align:center;border:1px solid #ccc;}");
        out.println("</style>");

        out.println("</head><body>");

        out.println("<h2 style='color:red'>Rejected Students</h2>");
